...
<a name= "6"></a>
## Git Tutorial
###Fork một repo sang git cá nhân

B1: Truy cập trang git cá nhân của bất kì ai chọn repo(repository) chọn fork về 

<img src=http://i.imgur.com/Y52ZfZ9.png>

B2: Tại Github Destop bạn làm theo bước tạo [Clone](https://github.com/hoanhieubk/Python/blob/master/README.md#222-clone)
...
Phần này là pull lên repo của người khác

Trên Git cá nhân trên Destrop bạn chọn pull request chọn branch rồi chọn send pull request rồi chọn admin của github bạn cần pulll phê duyệt là xong

<img src=http://i.imgur.com/rU8vsWo.png> 

kết quả việc pull lên github chờ phê duyệt

<img src=http://i.imgur.com/qztOl6X.png>
